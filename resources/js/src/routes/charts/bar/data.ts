...
export const negativeValueChart: ApexOptions = {
    chart: {
        height: 380,
        type: "bar",
        stacked: true,
    ...
    xaxis: {
        ...
        labels: {
            formatter: function (val: string) {
                return Math.abs(Math.round(Number.parseInt(val))) + "%";
            },
        },
    },
    legend: {
...
export const reversedChart: ApexOptions = {
    series: [
        {
...
export const imageChart: ApexOptions = {
    series: [
        {
            name: 'coins',
...
export const customDataLabelsChart: ApexOptions = {
    series: [
        {
...
export const patternChart: ApexOptions = {
    series: [
        {
            name: 'Marine Sprite',
...
export const chartWithMarker: ApexOptions = {
    series: [
        {
            name: 'Actual',
            data: [
