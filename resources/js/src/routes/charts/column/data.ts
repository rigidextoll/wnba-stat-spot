...
export const basicChart: ApexOptions = {
    series: [
        {
            name: 'Net Profit',
...
export const dataLabelsChart: ApexOptions = {
    series: [
        {
            name: 'Inflation',
...
export const stackedChart: ApexOptions = {
    series: [
        {
            name: 'Product A',
...
export const fullStackedChart: ApexOptions = {
    series: [
        {
            name: 'Product A',
...
export const markersChart: ApexOptions = {
    series: [
        {
            name: 'Actual',
            data: [
...
export const groupLabelChart: ApexOptions = {
    series: [
        {
            name: 'Sales',
            data: [
...
export const columnWithRotatedLabels: ApexOptions = {
    series: [
        {
            name: 'Servings',
...
export const columnWithNegativeValue: ApexOptions = {
    series: [
        {
            name: 'Cash Flow',
...
export const distributedColumn: ApexOptions = {
    series: [
        {
...
export const rangeColumn: ApexOptions = {
    series: [
        {
            name: 'Product A',
            data: [
...
export const yearChartOptions: ApexOptions = {
    series: [
        {
            data: makeData()
        }
...
export const quarterChartOptions: ApexOptions = {
    series: [
        {
            data: []
        }
