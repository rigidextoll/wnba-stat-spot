<script lang="ts">
    ...
    import {Button, Card, CardBody, CardHeader, CardTitle} from "@sveltestrap/sveltestrap";
    import ApexChart from "$lib/components/ApexChart.svelte";
    import {overviewChartOptions} from "./data";
</script>
...
<Card>
    ...
    <CardBody>
        <div dir="ltr">
            <ApexChart id="overview-chart" options={overviewChartOptions}/>
        </div>
    </CardBody>
</Card>