import type {ChatMsgType, ContactType, DropdownItemType, GroupType, UserContactType} from "./types";
...
export const chatMsg: ChatMsgType[] = [
    ...
    },
    {
        ...
        msg: [{
            isMedia: true,
            mediaContend: {title: 'financial-report-2024.zip', type: 'bxs-file-archive', size: '2.3 MB'}
